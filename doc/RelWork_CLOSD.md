...
- **[MAS (Multi-view Ancestral Sampling)](https://arxiv.org/abs/2310.14729)** - Kapon et al., 2024
...
- **[A-MDM](https://arxiv.org/abs/2306.00416)** - Shi et al., 2024
  - Interactive character control with auto-regressive motion diffusion models

- **[CAMDM (Taming Diffusion)](https://arxiv.org/abs/2404.15121v1)** - Chen et al., 2024
...
- **[Optimizing Diffusion Noise as Motion Priors](https://arxiv.org/abs/2312.11994)** - Karunratanakul et al., 2024
...
- **[Generating Human Motion in 3D Scenes](https://arxiv.org/abs/2405.07784)** - Cen et al., 2024
...
- **[Diffusion-based Generation in 3D Scenes](https://arxiv.org/abs/2301.06015)** - Huang et al., 2023
...
- **[SuperPADL](https://arxiv.org/abs/2407.10481)** - Juravsky et al., 2024
...
- **[Trajectory Optimization for Full-Body Movements](https://ieeexplore.ieee.org/abstract/document/6392834)** - Al Borno et al., 2012
  - Early work on trajectory optimization with complex contacts

- **[Physics-Based Motion Capture Imitation](https://dl.acm.org/doi/10.1145/3274247.3274506)** - Chentanez et al., 2018
  - Physics-based motion capture imitation with deep RL

### 4.2 Large-Scale Motion Tracking

- **[A Scalable Approach to Control Diverse Behaviors](https://dl.acm.org/doi/abs/10.1145/3386569.3392381)** - Won et al., 2020
  - Scaling to larger datasets for physically simulated character control

- **[PHC (Perpetual Humanoid Control)](http://arxiv.org/abs/2305.06456)** - Luo et al., 2023
  - Real-time simulated avatars with universal tracking policy on AMASS dataset (99% success rate)

- **[Supertrack](https://dl.acm.org/doi/10.1145/3478513.3480527)** - Fussell et al., 2021
...
- **[Embodied Scene-Aware Human Pose Estimation](https://arxiv.org/abs/2206.09106)** - Luo et al., 2022
...
- **[HumanML3D](https://ieeexplore.ieee.org/document/9880214)** - Guo et al., 2022
